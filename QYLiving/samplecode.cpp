...
#define INPUT_IMAGE_PATH "image/dse_1516695868.bmp"

bool readBmp241(const char* path, uint8_t **imageData, int *pWidth, int *pHeight)
{
...
int main1()
{
	...
	char SDKKey[] = "BV7ACCvnVGg3qBMLtcKrUn2ozjCgJKfBQN9AnoQrSFjy";
	...
	readBmp241(INPUT_IMAGE_PATH, (uint8_t**)&offInput.ppu8Plane[0], &offInput.i32Width, &offInput.i32Height);
